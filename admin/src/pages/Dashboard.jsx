...
<div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
  {cardsData.map((s,i) => (
    ...
    className={`p-6 rounded-2xl bg-linear-to-br h-full ${s.color} backdrop-blur-md border border-white/10 shadow-lg shadow-black/30 hover:bg-white/10 transition-all`}>

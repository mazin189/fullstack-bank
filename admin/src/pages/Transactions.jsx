...
<span className={`px-3 py-1 rounded-full text-sm font-semibold ${t.type === "deposit"? "bg-green-500/20 text-green-300" : t.type === "withdraw" ? "bg-red-500/20" : "bg-blue-500/20"}`}>
{t.type}
</span>
